...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> putItem(ItemDto itemDto, long itemId, long ownerId) {

        return patch("/" + itemId, ownerId, itemDto);
    }

    public ResponseEntity<Object> postComment(CommentDto commentDto, long itemId, long authorId) {
